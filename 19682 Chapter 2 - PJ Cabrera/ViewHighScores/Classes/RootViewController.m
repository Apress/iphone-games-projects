...
- (void)didReceiveMemoryWarning {
	...
	ViewHighScoresAppDelegate *appDelegate = 
		(ViewHighScoresAppDelegate *)[[UIApplication sharedApplication] delegate];
	[[appDelegate highScores] removeAllObjects];	
}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
	ViewHighScoresAppDelegate *appDelegate = 
	(ViewHighScoresAppDelegate *)[[UIApplication sharedApplication] delegate];
	return [[appDelegate highScores] count];	
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Set up the cell...
	ViewHighScoresAppDelegate *appDelegate = 
	(ViewHighScoresAppDelegate *)[[UIApplication sharedApplication] 
		delegate];
